...
func PrivateRoutes(a *fiber.App) {
	...
	// Stacks orchestration (docker-compose-free, repository-based)
	route.Get("/stacks/catalog", controllers.StacksCatalog)
	route.Get("/stacks/status", controllers.StacksStatus)
	route.Post("/stacks/up", controllers.StacksUp)
	route.Post("/stacks/down", controllers.StacksDown)
	route.Post("/stacks/restart", controllers.StacksRestart)
	route.Get("/stacks/repositories", controllers.StacksListRepositories)
	route.Post("/stacks/repositories", controllers.StacksAddRepository)
	route.Post("/stacks/repositories/update", controllers.StacksUpdateRepository)
	route.Post("/stacks/repositories/toggle", controllers.StacksToggleRepository)
	route.Post("/stacks/repositories/remove", controllers.StacksRemoveRepository)
	route.Post("/stacks/repositories/sync", controllers.StacksSyncRepositories)
	route.Post("/stacks/repositories/upload", controllers.StacksUploadRepository)
	route.Post("/stacks/services", controllers.StacksAddService)
	route.Post("/stacks/services/update", controllers.StacksUpdateService)
	route.Post("/stacks/services/remove", controllers.StacksRemoveService)
	route.Get("/stacks/env", controllers.StacksGetEnv)
	route.Post("/stacks/env", controllers.StacksSaveEnv)
	route.Get("/stacks/devenv/settings", controllers.StacksGetDevEnvSettings)
	route.Post("/stacks/devenv/settings", controllers.StacksSaveDevEnvSettings)
}
