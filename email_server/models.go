...
type EmailServerConfig struct {
	...
	// --- listener and policy settings ---

	// STARTTLSRequired refuses AUTH and mail submission on plaintext
	// connections. Implicit-TLS ports (465/993/995) are unaffected.
	STARTTLSRequired bool `json:"starttls_required"`
	// SubmissionOnly465 controls whether the implicit-TLS submission port is
	// opened alongside 587.
	SMTPSEnabled bool `json:"smtps_enabled"`
	// IMAPEnabled / IMAPsEnabled / POP3Enabled / POP3sEnabled toggle the
	// retrieval listeners individually.
	IMAPEnabled  bool `json:"imap_enabled"`
	IMAPsEnabled bool `json:"imaps_enabled"`
	POP3Enabled  bool `json:"pop3_enabled"`
	POP3sEnabled bool `json:"pop3s_enabled"`

	// Inbound authentication checks.
	CheckSPF          bool `json:"check_spf"`
	CheckDKIM         bool `json:"check_dkim"`
	...
	// OutboundHELO overrides the name used when greeting remote servers
	// (defaults to Hostname).
	OutboundHELO string `json:"outbound_helo"`
}
